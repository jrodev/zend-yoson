<?php
    ...
    if (!defined('FIRELOGGER_PASSWORD')) define('FIRELOGGER_PASSWORD', 'e5338282c8158d86dca3b1e6ace4c94f'); //vrb2n12
    ...
    class FireLogger
    {
        ...
        {
            if (!FireLogger::$enabled/* || FireLogger::$codeErr==8*/) return; // no-op
