...
$(function() {
    ...
    function runMap2(TPL){
        ...
        var eChangeDpto = function(idDpto){
            if(typeof(idDpto)!=='undefined' && idDpto!=''){
                var req = new ClassAjax('post', 'index/resultmap');
            ...
            geocoder.geocode( {'address': ubicacion}, function(results, status){ //alert(JSON.stringify(results)); //alert(mDump(results,1));
                if(status == google.maps.GeocoderStatus.OK){
                    ...
                    if(oDist.options[oDist.selectedIndex].text=='Elegir'){map.setZoom(11);}
                        ...
                        var reqDeps = new ClassAjax('POST', 'index/deps');
    ...
    $(function(){
            ...
            runMap2(tpl); /*console.log(DOM("#dpto"))*/
    });
    
    /*------------------------------------------------------------------------------------*/
    //Imagenes de muestra
    var imgsSrcs = {
        0: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-santiago-de-surco-843339-1369343172.jpg",
        1: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843344-1367505954.jpg",
        2: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-caima-842998-1362672778.jpg",
        3: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-caima-843000-1365725564.jpg",
        4: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843169-1367342547.jpg",
        5: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-santiago-de-surco-843177-1367335330.jpg",
        6: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843180-1367335202.jpg",
        7: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843184-1367505012.jpg",
        8: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843191-1367334771.jpg",
        9: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843250-1367333385.jpg",
        10: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843256-1367343579.jpg",
        11: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843263-1367342044.jpg",
        12: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843273-1367333066.jpg",
        13: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843288-1367342327.jpg",
        14: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-isidro-843294-1366394607.jpg",
        15: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843295-1367343762.jpg",
        16: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-isidro-843305-1363890301.jpg",
        17: "http://cde.urbania.clasificados.pe/images/inmuebles/thumbs/venta-departamento-san-borja-843336-1367336849.jpg"
    };
    
    $(".thumbnail img, .accordion-inner img").each(function(i,v){
        $(v).attr('src',imgsSrcs[i]);
    });
